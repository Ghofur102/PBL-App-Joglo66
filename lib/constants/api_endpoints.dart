...
class ApiEndpoints {
  ...
  static String get returnAttribute =>
      '$baseUrl/api/admin/return-rent-attribute';
  static String get historyAttribute =>
      '$baseUrl/api/admin/history-rent-attribute';
  ...
  static String get toggleAttribute =>
      '$baseUrl/api/admin/toggle-attribute-status';
  ...
  static String get rescheduleBooking =>
      '$baseUrl/api/admin/reschedule-booking';
  static String get cancelBooking => '$baseUrl/api/admin/cancel-booking';
  static String get listClosedBooking =>
      '$baseUrl/api/admin/list-close-booking';
  ...
  static String get expenseCategories =>
      '$baseUrl/api/admin/expense-categories';
